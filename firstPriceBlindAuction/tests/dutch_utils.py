...
def make_root_contract():
    auction_code = ts4.load_code_cell('DutchAuction')
    giver_code = ts4.load_code_cell('GiverNativeCurrency')
    bid_code = ts4.load_code_cell('BidNativeCurrencyDutch')
...
def magic_arg(amount):
    ARG_CALCULATOR = ts4.BaseContract(
        '__NativeCurrencyDutchBidRevealArgCalc',
        {},
        balance=10**10,
    )
...
def magic_constructor_arg(
    ...
    **kwargs,
    ...
    CONSTRUCTOR_ARG_CALCULATOR = ts4.BaseContract(
        '__NativeCurrencyDutchBidConstructorArgCalc',
        {},
        balance=10**10,
    )
    ...
    *,
    ...
    bid.call_method(
        ...
        magic_constructor_arg(
            ...
            startPrice_=start_price,
            priceStep_=price_step,
            root_=root_address,
