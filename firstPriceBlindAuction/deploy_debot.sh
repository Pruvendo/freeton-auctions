...
function giver {
    tonos-cli --url http://127.0.0.1 call --abi static/local_giver.abi.json $giver sendGrams "{\"dest\":\"$1\",\"amount\":10000000000}"
}
...
ICON_BYTES=$(base64 -w 0 static/hellodebot.png)
